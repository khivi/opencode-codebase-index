...
describe("blobsha utilities", () => {
  ...
  describe("activeFiles", () => {
    it("should return tracked files matching include patterns", () => {
      ...
      const files = activeFiles(tempDir, ["**/*.{ts,js}"]);
    ...
    it("should return empty array when no files match", () => {
      ...
      const files = activeFiles(tempDir, ["**/*.py"]);
      expect(files).toEqual([]);
    });

    it("should handle single extension patterns", () => {
    ...
    it("should handle nested files", () => {
      ...
      const files = activeFiles(tempDir, ["**/*.ts"]);
